...
Interestingly, as seen above, handling multiple pages of a book here is a lot like handling multiple webpages of a website. Only the *behavior* and arrangement of these (web)pages or iframes is that of a real book. Oftentimes developers think that page turning is like mimicking a physical book, and, therefore superfluous to the nature of web, but that is not an accurate view. Not anymore than mimicking a physical scroll that we're so used to.
