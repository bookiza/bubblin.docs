...
Or press '⌘ + M' to open a new project (See other keyboard [shortcuts]({{site.baseurl}}{% link _pages/shortcuts.markdown %}) on Bubblin).
...
<br/>
<br/>
A new project will look something like this: with three large gray colored textareas at the bottom to punch in HTML, CSS and JavaScript for each page of the book. It will also show four empty bluish colored pages (two leafs) that can be navigated to using left and right arrow buttons.
...
We're going to construct an HTML wrapper for our pages next. Do not worry if you haven't written HTML all your life because we're going to use an HTML [template](https://github.com/bookiza/templates) anyway:
